...
func main() {
	...
	if err := database.AutoMigrate(&models.Farmer{}, &models.Admin{}, &models.OTPChallenge{}, &models.Holding{}, &models.Entry{}, &models.Verification{}, &models.Score{}, &models.LedgerAnchor{}); err != nil {
		log.Fatal(err)
	}
